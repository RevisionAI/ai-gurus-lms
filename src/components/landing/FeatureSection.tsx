...
const features = [
    ...
    },
    {
        ...
        description: 'Cut through vendor hype. Learn the right questions to ask and how to calculate true implementation costs—not just quotes.',
        icon: (
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export default function FeatureSection() {
    return (
        <section className="relative w-full py-24 px-6 bg-slate-950/50 backdrop-blur-sm">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {features.map((feature, index) => (
                        <motion.div
                            ...
                            className="group p-8 rounded-2xl bg-white/5 border border-white/10 hover:bg-white/10 hover:border-indigo-500/30 transition-all duration-300"
                        >
